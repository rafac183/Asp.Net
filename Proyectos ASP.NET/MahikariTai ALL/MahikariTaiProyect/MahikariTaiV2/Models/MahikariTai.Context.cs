...
namespace MahikariTaiV2.Models
{
    ...
    public partial class db_MahikariTaiEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> cargos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("cargos");
        }
        ...
        public virtual ObjectResult<string> grupos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("grupos");
        }
        ...
        public virtual ObjectResult<miembroAllInfoKenshu_Result> miembroAllInfoKenshu(string rut_user)
        {
            var rut_userParameter = rut_user != null ?
                new ObjectParameter("rut_user", rut_user) :
                new ObjectParameter("rut_user", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<miembroAllInfoKenshu_Result>("miembroAllInfoKenshu", rut_userParameter);
        }
    
        public virtual int modificarKenshuMiembro(string rut_user, Nullable<System.DateTime> grado_date_ini, Nullable<System.DateTime> grado_date_int, Nullable<System.DateTime> grado_date_sup)
        {
            var rut_userParameter = rut_user != null ?
                new ObjectParameter("rut_user", rut_user) :
                new ObjectParameter("rut_user", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("modificarKenshuMiembro", rut_userParameter, grado_date_iniParameter, grado_date_intParameter, grado_date_supParameter);
        }
